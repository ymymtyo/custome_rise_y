 ...
 <div class="container">
  ...
  <table border="1" >
   ...
   <tbody>
    ...
    <c:forEach var="customerRegisterSearch" items="${sessionScope.customerRegisterSearchList}">
			 <tr>
			    ...
			    <c:url var="delete" value="/ProceedsDeleteServlet">
			 	 <c:param name="proceeds_id" value="${customerRegisterSearch.getSearch_proceeds_id()}"/>
			 	</c:url>
			    ...
			    <td><a href="${delete}" onclick="return Delete_Dialog()">削除</a> | <a href="${update}">編集</a></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_person()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_sales_date()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_customer_name()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_goods_name()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_goods_price()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_pcs()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_sales()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_goods_cost()}" /></td>
			 	<td><c:out value="${customerRegisterSearch.getSearch_profit()}" /></td>
			 </tr>
   	 </c:forEach>
